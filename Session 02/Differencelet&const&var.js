...
// This means that any variable that is declared with var outside a function block is 
...
// Here, greeter is globally scoped because it exists outside a function while 
// hello is function scoped. So we cannot access the variable hello outside of a function.
//  So if we do this:
...
// top of their scope before code execution. This means that if we do this:
...
// While this is not a problem if you knowingly want greeter to be redefined, it becomes a 
// problem when you do not realize that a variable greeter has already been defined before.
// If you have used greeter in other parts of your code, you might be surprised at the output 
// you might get. This will likely cause a lot of bugs in your code. 
...
// an improvement to var declarations. It also solves the problem with var that we 
// just covered. Let's consider why this is so.
...
// returns an error. This is because let variables are block scoped .
...
// When using let, you don't have to bother if you have used a name for a variable before 
// as a variable exists only within its scope.
...
// const object cannot be updated, the properties of this objects can be updated. Therefore,
...
// While var and let can be declared without being initialized, const must be initialized 
// during declaration.